...
- ###  ${{\color{red} Hardware Overview }} $ 
  #### 1. Mobility Management
    ...
    * [Vehicle 2D/3D Models CAD](https://github.com/kirkhu/WRO2023_FE-Shinan-Fire-On-All-Cylinders/blob/main/models/Vehicle_2D_3D/README.md)
  ...
  #### 2. Power and Sense Management
    ...
    - __Controller Selection__
      - [Introduce Jetson Nano ](https://github.com/kirkhu/WRO2023_FE-Shinan-Fire-On-All-Cylinders/blob/main/other/Jetson%20Nano)
      - [Introduce Raspberry pi ](https://github.com/kirkhu/WRO2023_FE-Shinan-Fire-On-All-Cylinders/blob/main/other/Raspberry_Pi)
...
- ### ${{\color{red} Software Overview }} $ 
  #### 3. Obstacle Management
    ...
    - __Image Processing and Predictions__
      - [Image Processing (圖像預測)]()  
      - [Steering Overview (轉向概述)]() 
    - __Programming__
