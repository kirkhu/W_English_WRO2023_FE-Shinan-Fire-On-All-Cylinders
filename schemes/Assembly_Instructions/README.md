...
<table>
  ...
  <tr>
     <td>  <img src="./img/up.png"  width = "400" alt="整體機體結構上視圖" > </td><td><img src="./img/Middle_Layer_Structure_Top_View.png" width = "400" alt="中層機體結構上視圖" ></td><td><img src="./img/Vehicle_Chassis_Design_top.png" width="400" alt="車輛底盤上視圖" ></td>
  </tr>
</table>
</div>
