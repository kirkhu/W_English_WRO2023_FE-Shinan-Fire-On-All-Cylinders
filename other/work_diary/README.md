...
- After reading the rules, We started to choose the controller. After watching the previous competitions, we found that most of them are raspberry pi but there are also jeston nano, so I decided to choose one of these two. In the end, I chose raspberry pi 4B because of its smaller size and cheaper price than jeston nano. 
  ...
  __Timeline Schedule for Competition Stages and Tasks(Gantt Chart)__ 
<div align="center" >
  <img src="../img/gantt.jpg" width = "600" height = "" alt="甘特圖" align=center />
</div>
...
<tr align="center">
  <th> LM2596 DC-DC </th> 
  <th>5A Constant Voltage and Constant Current Buck Power Module </th>
</tr>
<tr align="center">
...
<table >
<tr align="center">
  <th colspan="2">ydlidar x4、X2 Image distance </th> 
  <th >lidar 100 Image distance</th>
</tr>
<tr align="center">
